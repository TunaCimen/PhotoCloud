...
public class ImageSecretary {
	...
	public static ImageMatrix readResourceImage(String imName, String extension) throws IOException {
		System.out.println(IMAGE_LOCATION + imName +extension);
	...
	public static boolean writeImageToResources(RenderedImage image, String name, String extension) {
		boolean result = true;
		try {
			System.out.println(IMAGE_LOCATION + name + extension);
	...
	public static RenderedImage convertImageToRenderedImage(Image image){

		if(image instanceof RenderedImage bufferedImage){
